...
The folder "icf-jag-10k" houses the three JAG ICF dataset files, which are npy files for the parameters (5 inputs), scalars (15 outputs), and images. They are labeled as such.
